...
?>>home</a> / <a href="shop.php">shop</a> / literature</p>
</div>

<section class="products">

   <h1 class="title">literature books</h1>

   <div class="box-container">

      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category='literature' ORDER BY id DESC") or die('query failed');
