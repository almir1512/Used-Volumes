...
<div class="heading">
   <h3>our shop</h3>
   <p> <a href="home.php">home</a> / <a href="shop.php">shop</a> / medical</p>
</div>
...
<section class="products">
   ...
   <div class="box-container">
      ...
      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category='medical'") or die('query failed');
