...
<div class="heading">
   <h3>our shop</h3>
   <p> <a href="home.php">home</a> / <a href="shop.php">shop</a> / science</p>
</div>

<section class="products">

   <h1 class="title">Science books</h1>

   <div class="box-container">

      <?php  
         $select_products = mysqli_query($conn, "SELECT * FROM `products` WHERE category='science' ORDER BY id DESC") or die('query failed');
